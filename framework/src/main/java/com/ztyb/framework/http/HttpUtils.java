...
public class HttpUtils {
    ...
    public void download(File dir, String filename, EngineDownLoadCallBack callBack) {
        if (callBack == null) {
            callBack = EngineDownLoadCallBack.DEFAULT_CALL_BACK;
        }
        ...
        if (this.mIHttpEngine == null) {
            ...
            callBack.onPreExecute(this.mContext, this.mParams);
            download(this.mContext, this.mUrl, dir, filename, callBack);
        }
    }
    ...
    public void download(Context context, String url, File dir, String fileName, EngineDownLoadCallBack callBack) {
        mIHttpEngine.download(context, url, dir, fileName, callBack);
    }
