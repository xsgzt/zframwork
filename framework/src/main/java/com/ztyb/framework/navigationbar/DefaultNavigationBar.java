...
public class DefaultNavigationBar extends BaseNavigtionBar<DefaultNavigationBar.Builder.DefaultNavigationParams> {
    ...
    public void apply() {
        ...
        if (mParams.backgroundResource == R.color.white) {
            ((Activity) (mParams.mContext)).getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
