...
public class BannerView extends RelativeLayout {
    ...
    private boolean mDotIncontaineBottom = false;
    ...
    private void initAttribute(AttributeSet attrs) {
        ...
        mDotIncontaineBottom = array.getBoolean(R.styleable.BannerView_dotIncontaineBottom, mDotIncontaineBottom);
        // 获取点的颜色（默认、选中）
    ...
    private void intView() {
        ...
        if(mDotIncontaineBottom) {
            RelativeLayout.LayoutParams layoutParams = (LayoutParams) mDotContainerView.getLayoutParams();
            layoutParams.addRule(ALIGN_PARENT_BOTTOM);
            layoutParams.addRule(CENTER_IN_PARENT,0);
            layoutParams.addRule(CENTER_HORIZONTAL);
            mDotContainerView.setLayoutParams(layoutParams);
        }
